...
export const topRatedSeries = (page = 1) =>
  fetch(
    `https://api.themoviedb.org/3/tv/top_rated?api_key=${process.env.REACT_APP_API_KEY}&include_adult=false&region='EG'&page=${page}`
  )
    .then((res) => res.json())
    .then((data) => data);
...
export const SortByGenre = (page, genre, country) =>
  fetch(
    `https://api.themoviedb.org/3/discover/tv?&api_key=${process.env.REACT_APP_API_KEY}&include_adult=false&vote_average.gte=5&page=${page}&with_origin_country=${country}&with_genres=${genre}`
  )
    .then((res) => res.json())
    .then((data) => data);
...
export const SortByGenreAndDate = (page, order, genre, country) =>
  fetch(
    `https://api.themoviedb.org/3/discover/tv?&api_key=${process.env.REACT_APP_API_KEY}&include_adult=false&vote_average.gte=5&page=${page}&with_origin_country=${country}&sort_by=primary_release_date.${order}&with_genres=${genre}`
  )
    .then((res) => res.json())
    .then((data) => data);
...
export const SortByCountry = (page, country) =>
  fetch(
    `https://api.themoviedb.org/3/discover/tv?&api_key=${process.env.REACT_APP_API_KEY}&include_adult=false&vote_average.gte=5&include_video=false&language=en-US&page=${page}&with_origin_country=${country}`
  )
    .then((res) => res.json())
    .then((data) => data);
...
export const topRatedBycountry = (page=1, country) =>
  fetch(
    `https://api.themoviedb.org/3/discover/tv?&api_key=${process.env.REACT_APP_API_KEY}&include_adult=false&vote_average.gte=5&include_video=false&page=${page}&with_origin_country=${country}&sort_by=vote_average.desc`
  )
    .then((res) => res.json())
    .then((data) => data);

export const onAirBycountry = (page = 1, country) =>
  fetch(
    `https://api.themoviedb.org/3/discover/tv?&api_key=${process.env.REACT_APP_API_KEY}&include_adult=false&vote_average.gte=5&include_video=false&page=${page}&with_origin_country=${country}&sort_by=popularity.desc&air_date.gte=2023-01-01&air_date.lte=2024-11-25`
  )
    .then((res) => res.json())
    .then((data) => data);
...
export const popularBycountry = (page = 1, country) =>
  fetch(
    `https://api.themoviedb.org/3/discover/tv?&api_key=${process.env.REACT_APP_API_KEY}&include_adult=false&vote_average.gte=5&include_video=false&page=${page}&with_origin_country=${country}&sort_by=popularity.desc`
  )
    .then((res) => res.json())
    .then((data) => data);
